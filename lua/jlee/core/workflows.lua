...
vim.keymap.set(
	"n",
	"<leader>oo",
	":cd /Users/jlee/Library/Mobile Documents/iCloud~md~obsidian/Documents/newRec<cr>",
...
vim.keymap.set("n", "<leader>of", ":s/\\(# \\)[^_]*_/\\1/ | s/-/ /g<cr>", { desc = "strip date from note title" })
--
-- search for files in full vault
vim.keymap.set(
	"n",
	"<leader>os",
	"/Users/jlee/Library/Mobile Documents/iCloud~md~obsidian/Documents/newRec",
...
vim.keymap.set(
	"n",
	"<leader>ok",
	":!mv '%:p' '/Users/jlee/Library/Mobile Documents/iCloud~md~obsidian/Documents/newRec/zettelkasten/'<cr>:bd<cr>",
	{ desc = "file ok" }
)
